...
def make_error_util(ctx, err):
    if ctx is None:
        from projectname_sdk.core.context import CeoraterContext
        ctx = CeoraterContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, CeoraterError):
        errmsg = err.msg
