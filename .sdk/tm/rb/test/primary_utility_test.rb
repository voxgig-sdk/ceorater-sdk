...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = CeoraterOmni.make_runner(TEST_JSON_FILE, CeoraterSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : CeoraterOmni.errify(err)
    end
