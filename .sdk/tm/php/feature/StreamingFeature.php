...
// Ceorater SDK streaming feature
...
class CeoraterStreamingFeature extends CeoraterBaseFeature
{
    ...
    private function _iterate(CeoraterResult $result): \Generator
    {
    ...
    private function _streamable(CeoraterContext $ctx): bool
    {
