...
class CeoraterCacheFeature extends CeoraterBaseFeature
{
    ...
    private function _through(CeoraterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
