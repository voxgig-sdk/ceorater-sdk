...
// Ceorater SDK ratelimit feature
...
class CeoraterRatelimitFeature extends CeoraterBaseFeature
{
    ...
    private function _acquire(CeoraterContext $ctx): void
    {
    ...
    private function _track(CeoraterContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
