...
class CeoraterTimeoutFeature extends CeoraterBaseFeature
{
    ...
    private function _with_timeout(CeoraterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CeoraterContext $_ctx, float $ms): void
    {
        $client = $this->client;
