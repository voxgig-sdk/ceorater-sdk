...
// Ceorater SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CeoraterOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CeoraterOmni::structfix($now, Struct::undef()))
                        !== json_encode(CeoraterOmni::structfix($val, Struct::undef()))) {
