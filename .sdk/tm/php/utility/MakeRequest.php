...
// Ceorater SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CeoraterMakeRequest
{
    public static function call(CeoraterContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CeoraterResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CeoraterResponse($fetched);
        } else {
