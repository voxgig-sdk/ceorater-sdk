...
class CeoraterGraphql
{
    ...
    // equivalent.
    public static function body(CeoraterContext $ctx): mixed
    {
    ...
    public static function errors(CeoraterContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
