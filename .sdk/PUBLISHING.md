...
|---|---|---|
| `ts/` | @voxgig-sdk/ceorater-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ceorater-sdk \
      --repository voxgig-sdk/ceorater-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ceorater-sdk` shows it, and
`npm trust revoke @voxgig-sdk/ceorater-sdk --id=<id>` removes it.
