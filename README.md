...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/ceorater` | `npm install @voxgig-sdk/ceorater` |
| Python | `voxgig-sdk-ceorater` | `pip install voxgig-sdk-ceorater` |
| PHP | `voxgig-sdk/ceorater` | `composer require voxgig-sdk/ceorater` |
| Golang | `github.com/voxgig-sdk/ceorater-sdk/go` | `go get github.com/voxgig-sdk/ceorater-sdk/go` |
| Ruby | `voxgig-sdk-ceorater` | `gem install voxgig-sdk-ceorater` |
| Lua | `voxgig-sdk-ceorater` | `luarocks install voxgig-sdk-ceorater` |
