...
(0, node_test_1.describe)('GeneralEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [{ "active": true, "name": "status", "req": false, "type": "`$STRING`", "index$": 0 }, { "active": true, "format": "date-time", "name": "timestamp", "req": false, "type": "`$STRING`", "index$": 1 }], "name": "general", "op": { "load": { "input": "data", "name": "load", "points": [{ "active": true, "args": {}, "contract": { "id": "GET /health", "json": "{\"operationId\":\"getHealth\",\"parameters\":[],\"protocol\":\"http\",\"responses\":{\"200\":{\"content\":{\"application/json\":{\"schema\":{\"properties\":{\"status\":{\"example\":\"healthy\",\"type\":\"string\"},\"timestamp\":{\"format\":\"date-time\",\"type\":\"string\"}},\"type\":\"object\"}}},\"description\":\"API is healthy\"}},\"securitySource\":\"unspecified\"}", "source": "openapi3", "version": 1 }, "kind": "http", "method": "GET", "orig": "/health", "segments": [{ "lit": "health" }], "select": {}, "transform": { "req": "`reqdata`", "res": "`body`" }, "index$": 0 }], "key$": "load" } }, "relations": { "ancestors": [] }, "key$": "general", "name__orig": "general", "Name": "General", "name_": "general", "name-": "general", "NAME": "GENERAL", "index$": 3 }, { "active": true, "entity": "general", "key$": "BasicGeneralFlow", "kind": "basic", "name": "BasicGeneralFlow", "param": {}, "step": [{ "active": true, "data": {}, "input": { "ref": "general_ref01", "srcdatavar": "general_ref01_data", "suffix": "_dt0" }, "match": {}, "op": "load", "spec": [], "valid": [{ "apply": "TextFieldMark", "def": { "mark": "Mark01-general_ref01" } }], "index$": 0 }] }, 'General');
        }
        const client = setup.client;
        const struct = setup.struct;
        const isempty = struct.isempty;
        const select = struct.select;
        let general_ref01_data = Object.values(setup.data.existing.general)[0];
        // LOAD
        const general_ref01_ent = client.General();
        const general_ref01_match_dt0 = {};
        const general_ref01_data_dt0 = (await general_ref01_ent.load(general_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != general_ref01_data_dt0);
    });
});
