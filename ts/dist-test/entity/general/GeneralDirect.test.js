...
(0, node_test_1.describe)('GeneralDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-general', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-general', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CEORATER_TEST_GENERAL_ENTID'];
...
//# sourceMappingURL=GeneralDirect.test.js.map