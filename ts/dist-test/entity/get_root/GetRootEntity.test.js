...
(0, node_test_1.describe)('GetRootEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'get_root.' + op, live))
                return;
        }
        ...
        let get_root_ref01_data = Object.values(setup.data.existing.get_root)[0];
        // LOAD
        const get_root_ref01_ent = client.GetRoot();
        const get_root_ref01_match_dt0 = {};
        const get_root_ref01_data_dt0 = (await get_root_ref01_ent.load(get_root_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != get_root_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/get_root/GetRootTestData.json');
    ...
    let idmap = transform(['get_root01', 'get_root02', 'get_root03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CEORATER_TEST_GET_ROOT_ENTID'];
...
//# sourceMappingURL=GetRootEntity.test.js.map