...
(0, node_test_1.describe)('GetRootDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-get_root', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_root', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CEORATER_TEST_GET_ROOT_ENTID'];
...
//# sourceMappingURL=GetRootDirect.test.js.map