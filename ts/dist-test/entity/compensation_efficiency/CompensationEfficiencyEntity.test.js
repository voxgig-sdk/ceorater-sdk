...
(0, node_test_1.describe)('CompensationEfficiencyEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/compensation_efficiency/CompensationEfficiencyTestData.json');
    ...
    let idmap = transform(['compensation_efficiency01', 'compensation_efficiency02', 'compensation_efficiency03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=CompensationEfficiencyEntity.test.js.map