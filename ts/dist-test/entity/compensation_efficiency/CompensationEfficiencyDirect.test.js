...
(0, node_test_1.describe)('CompensationEfficiencyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-compensation_efficiency', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-compensation_efficiency', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CEORATER_TEST_COMPENSATION_EFFICIENCY_ENTID'];
...
//# sourceMappingURL=CompensationEfficiencyDirect.test.js.map