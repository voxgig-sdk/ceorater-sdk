...
function envOverride(m) {
    if ('TRUE' === process.env.CEORATER_TEST_LIVE ||
        'TRUE' === process.env.CEORATER_TEST_OVERRIDE) {
    ...
    m.CEORATER_TEST_EXPLAIN = process.env.CEORATER_TEST_EXPLAIN || m.CEORATER_TEST_EXPLAIN;
    return m;
}
