...
class CeoPerformanceEntity extends CeoraterEntityBase_1.CeoraterEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'ceo_performance';
        this.name_ = 'ceo_performance';
        this.Name = 'CeoPerformance';
    }
    make() {
        return new CeoPerformanceEntity(this._client, this.entopts());
    }
...
exports.CeoPerformanceEntity = CeoPerformanceEntity;
//# sourceMappingURL=CeoPerformanceEntity.js.map