...
class GeneralEntity extends CeoraterEntityBase<General> {
  ...
  make(this: GeneralEntity) {
    return new GeneralEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: GeneralLoadMatch, ctrl?: Control): Promise<GeneralEntity> {
