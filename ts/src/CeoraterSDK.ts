...
class CeoraterSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('CeoraterSDK: graphql: ' +
  ...
  CeoPerformance(entopts?: Record<string, any>) {
    const self = this
    return new CeoPerformanceEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  CompensationEfficiency(entopts?: Record<string, any>) {
    const self = this
    return new CompensationEfficiencyEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  GetRoot(entopts?: Record<string, any>) {
    const self = this
    return new GetRootEntity(self, entopts)
  }
