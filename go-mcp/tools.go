...
type Args struct {
	Entity string         `json:"entity" jsonschema:"ceo_performance | company | compensation_efficiency | general | get_root | search"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CeoraterSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "ceorater_list",
		Description: "List records from Ceorater. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "ceorater_load",
		Description: "Load a single record from Ceorater. " +
...
func runOp(client *sdk.CeoraterSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CeoraterSDK, name string) (sdk.CeoraterEntity, error) {
	switch strings.ToLower(name) {
	case "ceo_performance":
		return client.CeoPerformance(nil), nil
	case "company":
		return client.Company(nil), nil
	case "compensation_efficiency":
		return client.CompensationEfficiency(nil), nil
	case "general":
		return client.General(nil), nil
	case "get_root":
		return client.GetRoot(nil), nil
	case "search":
