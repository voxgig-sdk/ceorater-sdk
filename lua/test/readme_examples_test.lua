...
-- data to return.
local TEST_SEED = '{ entity = { ["ceo_performance"] = { ["test01"] = { id = "test01" } }, ["company"] = { ["test01"] = { id = "test01" } }, ["compensation_efficiency"] = { ["test01"] = { id = "test01" } }, ["general"] = { ["test01"] = { id = "test01" } }, ["get_root"] = { ["test01"] = { id = "test01" } }, ["search"] = { ["test01"] = { id = "test01" } } } }'
