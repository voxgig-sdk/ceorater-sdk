...
describe("GetRootDirect", function()
  it("should direct-load-get_root", function()
    local setup = get_root_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_root", setup.live and "live" or "unit")
...
function get_root_direct_setup(mockres)
