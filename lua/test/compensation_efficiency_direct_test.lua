...
describe("CompensationEfficiencyDirect", function()
  it("should direct-list-compensation_efficiency", function()
    local setup = compensation_efficiency_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-compensation_efficiency", setup.live and "live" or "unit")
...
function compensation_efficiency_direct_setup(mockres)
