...
describe("CeoPerformanceDirect", function()
  it("should direct-list-ceo_performance", function()
    local setup = ceo_performance_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-ceo_performance", setup.live and "live" or "unit")
...
function ceo_performance_direct_setup(mockres)
