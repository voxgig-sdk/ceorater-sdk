...
describe("GeneralDirect", function()
  it("should direct-load-general", function()
    local setup = general_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-general", setup.live and "live" or "unit")
...
function general_direct_setup(mockres)
