...
local CeoraterSDK = {}
CeoraterSDK.__index = CeoraterSDK
...
CeoraterSDK._make_feature = _make_feature


function CeoraterSDK.new(options)
  local self = setmetatable({}, CeoraterSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function CeoraterSDK:options_map()
...
function CeoraterSDK:get_utility()
  return Utility.copy(self._utility)
end


function CeoraterSDK:get_root_ctx()
  return self._rootctx
end


function CeoraterSDK:prepare(fetchargs)
...
function CeoraterSDK:direct(fetchargs)
...
-- by passing it.
function CeoraterSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function CeoraterSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "CeoraterSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function CeoraterSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = CeoraterSDK.new(sdkopts)
  sdk.mode = "test"
