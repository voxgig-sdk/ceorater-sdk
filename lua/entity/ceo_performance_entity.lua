...
local CeoPerformanceEntity = {}
CeoPerformanceEntity.__index = CeoPerformanceEntity


function CeoPerformanceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CeoPerformanceEntity)
  self._name = "ceo_performance"
  self._client = client
...
function CeoPerformanceEntity:get_name()
  return self._name
end


function CeoPerformanceEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CeoPerformanceEntity.new(self._client, opts)
end
...
function CeoPerformanceEntity:mark_deleted()
  self._deleted = true
end


function CeoPerformanceEntity:deleted()
  return true == self._deleted
end


function CeoPerformanceEntity:data_set(args)
  if args ~= nil then
...
function CeoPerformanceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CeoPerformanceEntity:match_set(args)
  if args ~= nil then
...
function CeoPerformanceEntity:match_get()
...
function CeoPerformanceEntity:stream(action, args, callopts)
...
function CeoPerformanceEntity:_run_op(ctx, post_done)
  local utility = self._utility
