...
AQL-driven CLI and REPL for the Ceorater SDK. Positional arguments are
...
./ceorater-cli load 1 ceo_performance
./ceorater-cli load '{id:1}' ceo_performance
