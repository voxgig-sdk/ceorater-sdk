...
func registerSDKWords(r *eng.Registry, client *sdk.CeoraterSDK) {
...
func runOp(client *sdk.CeoraterSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
