...
import (
	...
	"github.com/voxgig-sdk/ceorater-sdk/go/entity"
	"github.com/voxgig-sdk/ceorater-sdk/go/feature"
	_ "github.com/voxgig-sdk/ceorater-sdk/go/utility"
)
...
// instead of `sdk.NewCeoraterSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *CeoraterSDK  { return NewCeoraterSDK(nil) }
func Test() *CeoraterSDK { return TestSDK(nil, nil) }
