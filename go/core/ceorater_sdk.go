...
func (sdk *CeoraterSDK) OptionsMap() map[string]any {
...
func (sdk *CeoraterSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *CeoraterSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *CeoraterSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CeoraterSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *CeoraterSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *CeoraterSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("CeoraterSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *CeoraterSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CeoraterSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("CeoraterSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
