...
func NewGetRootEntity(client *core.CeoraterSDK, entopts map[string]any) *GetRootEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetRootEntity) GetName() string { return e.name }
...
func (e *GetRootEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetRootEntity) Deleted() bool {
	return e.deleted
}


func (e *GetRootEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetRootEntity(e.client, opts)
}

func (e *GetRootEntity) Data(args ...any) any {
...
func (e *GetRootEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetRoot; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetRootEntity) DataTyped(data ...GetRoot) GetRoot {
	if len(data) > 0 {
		return typedFrom[GetRoot](e.Data(asMap(data[0])))
	}
	return typedFrom[GetRoot](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetRoot (all fields
// optional at the wire level).
func (e *GetRootEntity) MatchTyped(match ...GetRoot) GetRoot {
	if len(match) > 0 {
		return typedFrom[GetRoot](e.Match(asMap(match[0])))
	}
	return typedFrom[GetRoot](e.Match())
}
...
func (e *GetRootEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetRootEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetRootLoadMatch and returns an GetRoot. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetRootEntity) LoadTyped(reqmatch GetRootLoadMatch, ctrl map[string]any) (GetRoot, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetRoot{}, err
	}
	return typedFrom[GetRoot](res), nil
}



func (e *GetRootEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetRootEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetRootEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetRootEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetRootEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
