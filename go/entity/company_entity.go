...
func NewCompanyEntity(client *core.CeoraterSDK, entopts map[string]any) *CompanyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CompanyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CompanyEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// CompanyListMatch and returns []Company. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CompanyEntity) ListTyped(reqmatch CompanyListMatch, ctrl map[string]any) ([]Company, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Company](res), nil
}
