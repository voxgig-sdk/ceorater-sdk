...
func NewGeneralEntity(client *core.CeoraterSDK, entopts map[string]any) *GeneralEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GeneralEntity) GetName() string { return e.name }
...
func (e *GeneralEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GeneralEntity) Deleted() bool {
	return e.deleted
}


func (e *GeneralEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGeneralEntity(e.client, opts)
}

func (e *GeneralEntity) Data(args ...any) any {
...
func (e *GeneralEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an General; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GeneralEntity) DataTyped(data ...General) General {
	if len(data) > 0 {
		return typedFrom[General](e.Data(asMap(data[0])))
	}
	return typedFrom[General](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through General (all fields
// optional at the wire level).
func (e *GeneralEntity) MatchTyped(match ...General) General {
	if len(match) > 0 {
		return typedFrom[General](e.Match(asMap(match[0])))
	}
	return typedFrom[General](e.Match())
}
...
func (e *GeneralEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GeneralEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GeneralLoadMatch and returns an General. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GeneralEntity) LoadTyped(reqmatch GeneralLoadMatch, ctrl map[string]any) (General, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return General{}, err
	}
	return typedFrom[General](res), nil
}



func (e *GeneralEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GeneralEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GeneralEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GeneralEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GeneralEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
