...
type CeoPerformanceEntity struct {
	name    string
...
func NewCeoPerformanceEntity(client *core.CeoraterSDK, entopts map[string]any) *CeoPerformanceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CeoPerformanceEntity) GetName() string { return e.name }
...
func (e *CeoPerformanceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CeoPerformanceEntity) Deleted() bool {
	return e.deleted
}


func (e *CeoPerformanceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCeoPerformanceEntity(e.client, opts)
}

func (e *CeoPerformanceEntity) Data(args ...any) any {
...
func (e *CeoPerformanceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CeoPerformance; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CeoPerformanceEntity) DataTyped(data ...CeoPerformance) CeoPerformance {
	if len(data) > 0 {
		return typedFrom[CeoPerformance](e.Data(asMap(data[0])))
	}
	return typedFrom[CeoPerformance](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CeoPerformance (all fields
// optional at the wire level).
func (e *CeoPerformanceEntity) MatchTyped(match ...CeoPerformance) CeoPerformance {
	if len(match) > 0 {
		return typedFrom[CeoPerformance](e.Match(asMap(match[0])))
	}
	return typedFrom[CeoPerformance](e.Match())
}
...
func (e *CeoPerformanceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CeoPerformanceEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CeoPerformanceEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CeoPerformanceListMatch and returns []CeoPerformance. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CeoPerformanceEntity) ListTyped(reqmatch CeoPerformanceListMatch, ctrl map[string]any) ([]CeoPerformance, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[CeoPerformance](res), nil
}



func (e *CeoPerformanceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CeoPerformanceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CeoPerformanceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CeoPerformanceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
