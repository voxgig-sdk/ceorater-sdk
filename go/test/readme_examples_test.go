...
const testSeed = `map[string]any{"entity": map[string]any{"ceo_performance": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "company": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "compensation_efficiency": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "general": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_root": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
