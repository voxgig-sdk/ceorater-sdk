...
class CeoraterProxyFeature extends CeoraterBaseFeature
{
    ...
    public function init(CeoraterContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CeoraterContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
