...
// Ceorater SDK clienttrack feature
...
class CeoraterClienttrackFeature extends CeoraterBaseFeature
{
    ...
    public function PostConstruct(CeoraterContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Ceorater-SDK';
