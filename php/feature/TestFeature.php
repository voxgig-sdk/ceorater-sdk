...
// Ceorater SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CeoraterTestFeature extends CeoraterBaseFeature
{
    ...
    public function init(CeoraterContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CeoraterContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CeoraterContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CeoraterContext $ctx, $op, $args): array
    {
