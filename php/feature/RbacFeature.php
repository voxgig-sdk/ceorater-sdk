...
class CeoraterRbacFeature extends CeoraterBaseFeature
{
    ...
    private function _required(CeoraterContext $ctx): ?string
    {
    ...
    private function _reject(CeoraterContext $ctx, string $required): void
    {
    ...
    private function _track(CeoraterContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
