...
// Ceorater SDK CeoPerformance entity
...
class CeoPerformanceEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CeoPerformanceEntity($this->_client, $opts);
    }

    /**
     * @param CeoPerformance|array $args CeoPerformance data (assoc-array) to store.
     */
    ...
    /**
     * @return CeoPerformance|array The current CeoPerformance data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CeoPerformance fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CeoPerformance fields).
     */
    ...
    /**
     * List CeoPerformance items matching the given filter.
     *
     * @param CeoPerformanceListMatch|array|null $reqmatch Match filter (any subset
     *   of CeoPerformance fields) as an assoc-array; CeoPerformanceListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CeoPerformance[]|array A list of CeoPerformance items as assoc-arrays at
