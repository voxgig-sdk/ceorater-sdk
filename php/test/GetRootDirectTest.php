...
class GetRootDirectTest extends TestCase
{
    public function test_direct_load_get_root(): void
    {
        $setup = get_root_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-get_root", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
