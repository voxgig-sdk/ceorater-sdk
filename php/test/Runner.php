...
class CeoraterTestRunner
{
    ...
    {
        $live = self::getenv('CEORATER_TEST_LIVE');
        $override = self::getenv('CEORATER_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CEORATER_TEST_EXPLAIN');
...
class_alias('CeoraterTestRunner', 'Runner');
class_alias('CeoraterHelpers', 'Helpers');
