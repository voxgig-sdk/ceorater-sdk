...
{
    private static function utility(): CeoraterUtility
    {
        return new CeoraterUtility();
    }
    ...
    private static function ctx(array $over = []): CeoraterContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CeoraterContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CeoraterOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CeoraterError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CeoraterOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CeoraterMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CeoraterOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CeoraterMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CeoraterOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CeoraterMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CeoraterSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CeoraterMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CeoraterResponse([]),
            'result' => new CeoraterResult([]),
        ]);
        [, $err] = CeoraterMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CeoraterSpec([]),
            'response' => null,
            'result' => new CeoraterResult([]),
        ]);
        [, $err] = CeoraterMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CeoraterSpec(['step' => 's']),
            'response' => new CeoraterResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CeoraterResult([]),
        ]);
        [, $err] = CeoraterMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CeoraterSpec(['step' => 's']),
            'response' => new CeoraterResponse(self::resp(200, ['v' => 1])),
            'result' => new CeoraterResult([]),
        ]);
        [, $err] = CeoraterMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CeoraterSpec(['step' => 's']),
            'response' => new CeoraterResponse(self::resp(200, ['v' => 2])),
            'result' => new CeoraterResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CeoraterMakeResponse::call($ctx);
    ...
    {
        $preset = new CeoraterResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CeoraterSpec([]),
            'response' => new CeoraterResponse([]),
            'result' => new CeoraterResult([]),
        ...
        [$got, $err] = CeoraterMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CeoraterResult([])]);
        [, $err] = CeoraterMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CeoraterSpec([]), 'result' => null]);
        [, $err] = CeoraterMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CeoraterSpec(['step' => 's']),
            'result' => new CeoraterResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CeoraterOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CeoraterMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CeoraterSpec(['step' => 's']),
            'result' => new CeoraterResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CeoraterOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CeoraterMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CeoraterResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CeoraterSpec([]),
            'result' => new CeoraterResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CeoraterMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CeoraterMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CeoraterError('boom', 'boom');
        $utility->fetcher = function (CeoraterContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CeoraterSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CeoraterMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CeoraterContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CeoraterMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CeoraterResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CeoraterContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CeoraterSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CeoraterMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CeoraterResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CeoraterSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CeoraterMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CeoraterMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CeoraterMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CeoraterResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CeoraterDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CeoraterResult(['ok' => false])]);
        $this->expectException(CeoraterError::class);
        CeoraterDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CeoraterResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CeoraterMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CeoraterMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CeoraterBaseFeature();
        $b = new CeoraterBaseFeature();
        CeoraterFeatureAdd::call($ctx, $a);
        CeoraterFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CeoraterBaseFeature
    {
        $f = new CeoraterBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CeoraterFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CeoraterContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CeoraterSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CeoraterPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CeoraterResponse(['headers' => null]),
            'result' => new CeoraterResult([]),
        ]);
        CeoraterResultHeaders::call($ctx);
