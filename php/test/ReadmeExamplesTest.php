...
// Ceorater SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CeoraterSDK::test)
...
{
    private const SDK_CLASS = 'CeoraterSDK';
    ...
    private const SDK_BASE = 'ceorater_sdk';
