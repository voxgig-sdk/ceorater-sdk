...
class GeneralDirectTest extends TestCase
{
    public function test_direct_load_general(): void
    {
        $setup = general_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-general", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
