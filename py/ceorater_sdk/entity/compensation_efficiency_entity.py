...
from ceorater_sdk.ceorater_types import (
...
class CompensationEfficiencyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CompensationEfficiencyEntity(self._client, opts)
    ...
    def data_get(self) -> CompensationEfficiency:
    ...
    def match_get(self) -> CompensationEfficiency:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CompensationEfficiency]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CompensationEfficiency().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
