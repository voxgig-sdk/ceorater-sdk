...
from ceorater_sdk.utility import register

# Load features
from ceorater_sdk.feature.base_feature import CeoraterBaseFeature
from ceorater_sdk.features import _has_feature, _make_feature
...
class CeoraterSDK:
    ...
    def get_utility(self):
        return CeoraterUtility.copy(self._utility)
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "CeoraterSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CeoraterSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def CeoPerformance(self, data=None) -> "CeoPerformanceEntity":
        ...
        from ceorater_sdk.entity.ceo_performance_entity import CeoPerformanceEntity
    ...
    def Company(self, data=None) -> "CompanyEntity":
        ...
        from ceorater_sdk.entity.company_entity import CompanyEntity
    ...
    def CompensationEfficiency(self, data=None) -> "CompensationEfficiencyEntity":
        ...
        from ceorater_sdk.entity.compensation_efficiency_entity import CompensationEfficiencyEntity
    ...
    def General(self, data=None) -> "GeneralEntity":
        ...
        from ceorater_sdk.entity.general_entity import GeneralEntity
    ...
    def GetRoot(self, data=None) -> "GetRootEntity":
        ...
        from ceorater_sdk.entity.get_root_entity import GetRootEntity
        return GetRootEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from ceorater_sdk.entity.search_entity import SearchEntity
        return SearchEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "CeoraterSDK":
        if sdkopts is None:
            sdkopts = {}
