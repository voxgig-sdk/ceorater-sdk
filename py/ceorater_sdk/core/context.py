...
from ceorater_sdk.core.helpers import get_ctx_prop, to_map
...
class CeoraterContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, CeoraterResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CeoraterResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CeoraterError(code, msg, self)
