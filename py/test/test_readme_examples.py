# Ceorater SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CeoraterSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CeoraterSDK(...) and CeoraterSDK.test(...) become
#      CeoraterSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ceorater_sdk"
_SDK_CLASS = "CeoraterSDK"
...
_ENTITIES = {
    "CeoPerformance": "ceo_performance",
    "Company": "company",
    "CompensationEfficiency": "compensation_efficiency",
    "General": "general",
    "GetRoot": "get_root",
    "Search": "search",
}
