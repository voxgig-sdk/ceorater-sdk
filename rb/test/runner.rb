...
module CeoraterTestRunner
  ...
  def self.env_override(m)
    live = getenv("CEORATER_TEST_LIVE")
    override = getenv("CEORATER_TEST_OVERRIDE")
    ...
    explain = getenv("CEORATER_TEST_EXPLAIN")
    m["CEORATER_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = CeoraterTestRunner
Helpers = CeoraterHelpers
Vs = VoxgigStruct
