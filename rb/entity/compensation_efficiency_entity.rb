...
class CompensationEfficiencyEntity
  ...
  def make
    opts = @_entopts.dup
    CompensationEfficiencyEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [CompensationEfficiencyListMatch, Hash, nil] match filter (any subset of
  #   CompensationEfficiency fields); defaults to nil, treated as an empty match that lists all.
