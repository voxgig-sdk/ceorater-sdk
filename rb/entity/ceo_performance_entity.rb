...
class CeoPerformanceEntity
  ...
  def make
    opts = @_entopts.dup
    CeoPerformanceEntity.new(@_client, opts)
  end
  ...
  # @return [CeoPerformance, Hash] the current CeoPerformance data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CeoPerformance fields)
  def match_get
  ...
  #
  # @param reqmatch [CeoPerformanceListMatch, Hash, nil] match filter (any subset of
  #   CeoPerformance fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<CeoPerformance>, Array] the matching CeoPerformance items; raises CeoraterError on failure
