...
class GeneralEntity
  ...
  def make
    opts = @_entopts.dup
    GeneralEntity.new(@_client, opts)
  end
  ...
  # @return [General, Hash] the current General data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of General fields)
  def match_get
  ...
  #
  # @param reqmatch [GeneralLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.General.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [General, Hash] the loaded General; raises CeoraterError on failure
